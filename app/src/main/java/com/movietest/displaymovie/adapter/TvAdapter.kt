...
import com.movietest.displaymovie.activity.DetailsTvActivity
...
class TvAdapter(private val context: Context) :
    ...
    private var movieResults: MutableList<TvResult>?
    private var isLoadingAdded = false
    fun setMovies(movieResults: MutableList<TvResult>?) {
        this.movieResults = movieResults
        notifyDataSetChanged()
    }

    var result: TvResult? = null
    ...
    fun addAll(moveResults: List<TvResult>) {
    ...
    fun getItem(position: Int): TvResult {
    ...
    */
    protected inner class MovieVH(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            ll_card.setOnClickListener {
                val i = Intent(context, DetailsTvActivity::class.java)
    ...
    fun filter(list: MutableList<TvResult>?) {
        movieResults = list
        notifyDataSetChanged()
    }
